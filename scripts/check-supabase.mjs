...
console.log('4. supabase/schema-v4.sql')
console.log('5. supabase/seed.sql')
console.log('6. supabase/seed-v2.sql')
console.log('7. supabase/seed-v3.sql')
console.log('8. supabase/seed-v4.sql')
